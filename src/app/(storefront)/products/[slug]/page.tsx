  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
        ...
        <div>
          {product.category && (
            <p className="mb-2 inline-block border-2 border-comic-ink bg-comic-cyan px-2 py-0.5 text-sm font-bold text-comic-ink">
          ...
          <div className="mt-4 flex items-center gap-3">
            <span className="border-3 border-comic-ink bg-comic-yellow px-3 py-1 text-3xl font-bold text-comic-ink shadow-comic-sm">
